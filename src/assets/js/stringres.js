var resources = {
	...
	"navEventSub2": "Science Camp 2018",
	...
	//Main side
	"indexHeader1": "Science Camp 2018",
	"indexItem1": "Das Science Camp geht dieses Jahr in eine weitere Runde, und zwar in den beiden Wochen vom <b>6. August - 17. August</b>. Wir werden wieder bei der Skihütte in Weiler sein, dieses Jahr mit dem Thema \"Reise um die Welt\". Wir möchten verschiedene Kulturen, deren Lebensweise, Essgewohnheiten, Musik, Behausungen und vieles weitere näher betrachten. Das Programm wird wie gewohnt mit vielen Spielen, Singen und tollen Ausflügen abgerundet. Weitere Informationen finden sich auf der <a href='/veranstaltungen/sciencecamp'>Veranstaltungsseite</a>. Die Freizeit wird auch dieses Jahr wieder von der Stiftung Kinderland Baden-Württemberg unterstützt.",
	"indexHeader2": "Lagersuche",
	"indexItem2": "Derzeit sind wir auf der Suche nach einer Lagermöglichkeit, die wir für unser Material nutzen können. Leider können wir das bisherige Lager nach dem Science Camp nicht mehr nutzen, daher benötigen wir dringend eine Alternative, um weiterhin unsere Veranstaltungen und Projekte umsetzen zu können. Das Lager sollte trocken sein und abgeschlossen werden können. In Frage kommt eine Garage, eine Scheune, Kellerräumlichkeiten oder ähnliches. Sollten Sie uns hier weiterhelfen können, melden Sie sich gerne bei uns (<a href='/kontakt.html'>Kontakt</a>).",
	"indexHeader3": "Anmelde-Status Science Camp",
	"indexItem3": "Die Anmeldung ist geschlossen, auf der Warteliste stehen noch einige Anmeldungen. Wir gehen aktuell jedoch nicht davon aus, dass noch Plätze frei werden. Wenn Sie in Zukunft rechtzeitig über unsere Angebote informiert sein möchten, können Sie sich für unseren <a href='/verein/newsletter.html'>Newsletter</a> anmelden.<br>Eine EMail mit Informationen zum Busshuttle und der Zahlungsaufforderung sollten alle Eltern bereits erhalten haben. In den nächsten Tagen sollte auserdem auf dem Postweg ein Brief mit weiteren Informationen und inbesondere dem \"Freizeitpass\" ankommen, diesen bitte am ersten Tag ausgefüllt mitgeben.",
	//Wir
    ...
    "ocItem6Str": "Vielen Dank für Ihr Interesse. Alle Plätze sind bereits belegt, wir können leider keine weiteren Anmeldungen annehmen!",
    ...
    "ocanmeldungItem1Str1": "Zur Anmeldung füllen Sie bitte dieses Forumlar aus. Sind die Daten erfolgreich bei uns eingegangen, wird eine automatische EMail an die angegebene Adresse verschickt. Aktualisieren Sie dazu ggf. ihren EMail-Ordner. <i>Aktuell sind alle Plätze belegt. Weitere Anmeldungen können wir nur noch auf die Warteliste aufnehmen.",
	...
	"scItem1Str4": "Wir freuen uns, euch willkommen zu heißen!<br><br><b>Hinweis Bestätigungsmails:</b> Wir haben festgestellt, dass vereinzelt unsere Bestätigungsmails trotz Personalisierung im Spam-Ordner landen. Insbesondere ist dies bei GMail-Adressen der Fall. Bitte prüfen Sie deshalb auch den Spam-Ordner, falls Sie noch auf eine Bestätigung warten. Wir ändern unsere Formulierung, in der Hoffnung, dass die Mails nicht mehr als Spam markiert werden.",
	"scItem2Header": "Wo",
