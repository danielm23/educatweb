var resources = {
	...
	//Main side
	"indexHeader1": "Rückblick Science Camp 2018",
	"indexItem1": "Zwei Wochen lang waren über 60 fröhliche Kinder rund um die Skihütte in Weiler zu hören. Inzwischen erinnert außer dem vertrockneten Gras dort nichts mehr an das Science Camp 2018. Was bleiben sind eine Menge Erinnerungen. Wir haben viel positives Feedback von Kindern, Jugendlichen und Eltern erhalten und sind deshalb sicher, dass es den Teilnehmern auch dieses Jahr viel Spaß gemacht hat.<br>Derzeit sind wir noch damit beschäftigt, alle Bilder (es sind wieder mehrere tausend!) zu sichten und auszusortieren. Wir melden uns per Mail bei den Eltern, sobald wir damit fertig sind. Auch sind ein paar Fundsachen zusammengekommen, wenn ihr Kind etwas vermisst, melden Sie sich bei uns.",
	"indexHeader2": "Ausflug Speyer",
	"indexItem2": "Im Oktober planen wir einen Ausflug ins Technikmuseum Speyer. Am 13. Oktober wollen wir mit einem Bus dorthin fahren und einen Tag lang das Space Shuttle Buran, einen Jumbo-Jet, ein U-Boot und weitere interessante Ausstellungsstücke anschauen. Sobald eine Anmeldung möglich ist, melden wir uns hier, per Mail und auf Social Media.",
	"indexHeader3": "Werwolf Camp 2019",
	"indexItem3": "Nach einem erfolgreichen ersten Werwolf Camp in diesem Jahr planen wir für nächstes Jahr eine Wiederholung. Wieder soll sich alles rund um das beliebte Spiel \"Werwolf\" drehen. Am Science Camp haben wir bereits Flyer verteilt, demnächst gibt es auch hier weitere Informationen und die Anmeldung.",
	//Wir
